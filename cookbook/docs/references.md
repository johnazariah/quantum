...
| *Qubit-Efficient Encodings for Binary Optimisation Problems* | Azariah et al. | Shameless plug — our book on encoding fermions onto qubits. A companion to the Circuit Bench quantum simulation notes |
