...
d = CircuitDrawer(3, 26, figscale=0.35)
...
for offset in [0, 12]:
    ...
    d.ccx(0, 1, 2, b+2)
    d.gate(2, b+3, 'H')
    d.gate(1, b+4, 'X', color='#D94A4A')
    d.barrier(b+4.7, label='Diffusion')
    d.gate(0, b+5, 'H'); d.gate(1, b+5, 'H'); d.gate(2, b+5, 'H')
    d.gate(0, b+6, 'X', color='#D94A4A'); d.gate(1, b+6, 'X', color='#D94A4A'); d.gate(2, b+6, 'X', color='#D94A4A')
    d.gate(2, b+7, 'H')
    d.ccx(0, 1, 2, b+8)
    d.gate(2, b+9, 'H')
    d.gate(0, b+10, 'X', color='#D94A4A'); d.gate(1, b+10, 'X', color='#D94A4A'); d.gate(2, b+10, 'X', color='#D94A4A')
    d.gate(0, b+11, 'H'); d.gate(1, b+11, 'H'); d.gate(2, b+11, 'H')
d.measure(0, 25); d.measure(1, 25); d.measure(2, 25)
...
d = CircuitDrawer(2, 4)
d.gate(1, 0, 'X', color='#D94A4A')
d.barrier(0.7, label='Ansatz')
d.gate2(0, 1, 'Ry', color='#E67E22')
d.cnot(0, 1, 2)
d.measure(0, 3); d.measure(1, 3)
