---
date: 2026-10-13
slug: fenwick-trees-and-bravyi-kitaev
categories:
...
social:
  ...
  bluesky: 'Parity is one bit, so why does Jordan-Wigner read every qubit below the target? The Fenwick tree, a prefix-sum structure from 1994, answers in O(log n). I build the Bravyi-Kitaev encoding from it and verify all the anticommutators.'
---
